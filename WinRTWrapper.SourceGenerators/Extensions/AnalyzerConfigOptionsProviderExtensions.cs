...
namespace WinRTWrapper.SourceGenerators.Extensions
{
    ...
    internal static class AnalyzerConfigOptionsProviderExtensions
    {
        ...
        /// <summary>
        /// Gets the value of a <see cref="string"/> MSBuild property.
        /// </summary>
        /// <param name="options">The input <see cref="AnalyzerConfigOptionsProvider"/> instance.</param>
        /// <param name="propertyName">The MSBuild property name.</param>
        /// <returns>The value of the specified MSBuild property.</returns>
        /// <remarks>The return value is equivalent to a <c>'$(PropertyName)'</c> check.</remarks>
        public static string GetStringMSBuildProperty(this AnalyzerConfigOptionsProvider options, string propertyName) =>
            options.GlobalOptions.TryGetValue($"build_property.{propertyName}", out string? propertyValue) ? propertyValue : string.Empty;
