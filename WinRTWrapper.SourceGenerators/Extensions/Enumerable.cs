...
namespace WinRTWrapper.SourceGenerators.Extensions
{
    public static class Enumerable
    {
        ...
        /// <summary>
        /// Unwraps a collection of collections into a single collection.
        /// </summary>
        /// <typeparam name="TSource">The type of the elements of <paramref name="source"/>.</typeparam>
        /// <param name="sources">The collections to be unwrapped.</param>
        /// <returns>The unwrapped collection containing all elements from the provided collections.</returns>
        public static IEnumerable<TSource> Unwrap<TSource>(params IEnumerable<IEnumerable<TSource>?> sources)
        {
            if (sources is null)
            {
